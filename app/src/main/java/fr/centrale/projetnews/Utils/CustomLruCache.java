...
/**
 * Created by gperouffe on 08/01/2018.
 *
 * Based on code found at http://blog.lemberg.co.uk/volley-part-3-image-loader
 */
...
public class CustomLruCache
    ...
    public static RequestQueue newRequestQueue(Context context) {
        ...
        if (rootCache == null) {
            Log.w( Consts.TAG, "Can't find External Cache Dir, "
    ...
    public CustomLruCache(int sizeInKiloBytes) {
